        ...
        while (attemptRun <= maxAttemptsForRound) {
          ...
          if (!useExistingProgress) {
            ...
            const keepSettings = {
              ...
              ...(prevState?.cpaReloginQueueSource === 'cpa-401'
                ? { nodeStatuses: { 'cpa-relogin-prepare': 'completed' } }
                : {}),
              ...
              cpaReloginQueue: prevState.cpaReloginQueue,
              cpaReloginQueueCounts: prevState.cpaReloginQueueCounts,
              cpaReloginQueueSource: prevState.cpaReloginQueueSource,
              cpaReloginQueueUpdatedAt: prevState.cpaReloginQueueUpdatedAt,
              loginConfigEmailQueue: prevState.loginConfigEmailQueue,
              loginConfigEmailQueueSourcePath: prevState.loginConfigEmailQueueSourcePath,
              loginConfigEmailQueueUpdatedAt: prevState.loginConfigEmailQueueUpdatedAt,
              ...
              cloudflareTempEmailLookupMode: prevState.cloudflareTempEmailLookupMode,
